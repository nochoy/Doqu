  ...
  return (
    <DropdownMenu>
      {isMobile ? (
          ...
          <Button variant="ghost" className="py-6 px-2 rounded-xl">
            ...
            <div className="flex flex-col items-start">
              {isAuthenticated ? (
                ...
                <p className="justify-self-center text-muted-foreground font-normal">
                  Not signed in
                </p>
              )}
            </div>
        ...
        <DropdownMenuTrigger
          className="flex items-center cursor-pointer p-1 h-9 w-auto gap-0.5"
      ...
      >
        ...
        <DropdownMenuLabel>
          ...
          <p className="text-muted-foreground text-sm font-normal truncate">{currentUser?.email}</p>
        </DropdownMenuLabel>
